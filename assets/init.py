...
class ServiceRun():
  ...
  def set_ldap(self, enable, auth_format, host, user, password, list_admins, search_base_group, search_base_user, group_query, group_differential_query, person_query, person_differential_query):
      ...
      if enable == "true":
          ...
          self.replace_all(ALFRESCO_PATH + '/tomcat/shared/classes/alfresco-global.properties', 'authentication.protection.enabled\s*=.*', 'authentication.protection.enabled=false')
